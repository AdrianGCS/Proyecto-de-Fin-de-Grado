...
private static final String TAG="MainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView=(MapView)findViewById(R.id.mapav);
    ...
    protected void inicializalocaengine(){
    ...
    if(lastlocation !=null){
        ...
        setCameraPosicion(lastlocation);
    ...
    @SuppressWarnings("MissingPermission")
    private void inicializalocalayer(){
    ...
    private void setCameraPosicion(Location location){
    ...
    public void onMapClick(@NonNull LatLng point) {
        ...
        boto.setBackgroundResource(R.color.mapbox_blue);
    }
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        if(response.body()== null){
                            Log.e(TAG,"NO RUTAS, NO VALEN");
                            return;
                        }else if(response.body().routes().size()== 0){
                            Log.e(TAG,"NO he encontrado rutas");
                            return;
                        }
